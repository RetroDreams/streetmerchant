...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      x56hotas: envOrNumber(process.env.MAX_PRICE_SERIES_X56HOTAS),
      nuphyf1caps: envOrNumber(process.env.MAX_PRICE_SERIES_NUPHYF1CAPS),
      nuphytest: envOrNumber(process.env.MAX_PRICE_SERIES_NUPHYTEST),
    },
  },
